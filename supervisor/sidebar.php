...
/**
 * ================================================
 * INVESTHOOD IT - Supervisor Sidebar
 * ================================================
 * Reusable sidebar for Supervisor pages.
 */
if (!isset($user)) {
    $user = current_user();
}
...
<aside class="sidebar">
    ...
    <nav class="sidebar__nav">
        ...
        <ul class="sidebar__menu">
            <li>
                <a href="<?= url('supervisor/dashboard.php') ?>"
            ...
            <li>
                <a href="<?= url('supervisor/candidates.php') ?>"
            ...
            <li>
                <a href="<?= url('supervisor/reports.php') ?>"
