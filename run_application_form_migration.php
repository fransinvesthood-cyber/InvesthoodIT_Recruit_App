<?php
/**
 * Temporary migration runner for Stage 3 application form.
 * Executes database/application_form.sql using the existing PDO/MySQLi.
 */

require_once __DIR__ . '/includes/bootstrap.php';

$sql = file_get_contents(__DIR__ . '/database/application_form.sql');
if ($sql === false) {
